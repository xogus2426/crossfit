	...
	$(document).ready(function() {
		$("#btn_update").click(function() {
			...
			$.ajax({
				...
				, url : "${pageContext.request.contextPath}/brdevent"
				, data : JSON.stringify({
					bno : $("#bno").val()
					, title : $("#title").val()
					, writer : $("#writer").val()
...
location.href="${pageContext.request.contextPath}/event/list"
		...
		$("#btn_back").click(function() {
			location.href="${root}/event/detail?bno=827";
		});//click
	});//ready
	</script>
