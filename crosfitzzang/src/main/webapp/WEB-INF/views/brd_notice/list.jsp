...
<body>
	...
	<div class="container">
		...
		<br>
		<h1 class="text-muted text-center mt-3 mb-3">공지 게시판</h1>
		<hr>
		...
		$(document).ready(function() {
			...
			$("#btn_wform").click(function() {
				location.href="${root}/notice/wform";
			});//click
		});//ready
		...
		<table class="table table-hover">
			...
			<c:forEach var="dto" items="${board_list}">
				<tr>
					<td>${dto.bno}</td>
					<td>
					<a href="${pageContext.request.contextPath}/notice/detail?bno=${dto.bno}">
					${dto.title}
					</a>
					</td>
					<td>${dto.writer}</td>
...
<li class="page-item">
	<a class="page-link"
		href="${root}/board/list?reqPage=${beginPage-1}${search_uri1}${search_uri2}">
		Before
	</a>
</li>
</c:if>
...
<li class="page-item">
	<a class="page-link"
		href="${root}/board/list?reqPage=${page_num}${search_uri1}${search_uri2}">
		${page_num}
	</a>
</li>
</c:forEach>
...
<li class="page-item">
	<a class="page-link "
		href="${root}/board/list?reqPage=${endPage+1}${search_uri1}${search_uri2}">
		Next
	</a>
</li>
</c:if>
