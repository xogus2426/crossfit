...
@RestController
@RequestMapping(value ="/brdm2m")
public class MMRestController {

	private static final Logger logger
	= LoggerFactory.getLogger(MMRestController.class);
	...
	public int delete(@RequestBody MMDTO inDto) {

		MMDTO dto = service.detail(inDto.getBno());
	...
	public int update(@RequestBody MMDTO inDto) {
