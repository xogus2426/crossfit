...
@RestController
@RequestMapping(value ="/brdnotice")
public class NoticeRestController {

	private static final Logger logger
	= LoggerFactory.getLogger(NoticeRestController.class);
	...
	public int delete(@RequestBody NoticeBoardDTO inDto) {

		NoticeBoardDTO dto = service.detail(inDto.getBno());
	...
	public int update(@RequestBody NoticeBoardDTO inDto) {
