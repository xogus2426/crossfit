...
@RestController
@RequestMapping(value ="/brdmbr")
public class MbrRestController {

	private static final Logger logger
	= LoggerFactory.getLogger(MbrRestController.class);
	...
	public int delete(@RequestBody MbrBoardDTO inDto) {

		MbrBoardDTO dto = service.detail(inDto.getBno());
	...
	public int update(@RequestBody MbrBoardDTO inDto) {
